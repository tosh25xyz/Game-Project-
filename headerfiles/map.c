...
void InitTileRects(Rectangle tileRects[])
{
    ...
    tileRects[11] = TILE(11, 0);  // ROck
    tileRects[12] = TILE(12, 0);  // DARK CAVE BORDER
    tileRects[13] = TILE(13, 0);  // DARK CAVE BORDER side
    tileRects[14] = TILE(14, 0);  // DARK CAVE BORDER curve
    tileRects[15] = TILE(15, 0);  // DOOR
    tileRects[16] = TILE(16, 0); // sea edge
    tileRects[17] = TILE(17, 0); // corner sea
    tileRects[18] = TILE(18, 0); // middlesea edge
    tileRects[19] = TILE(19, 0); // side sea edge
    tileRects[20] = TILE(20, 0);  // QUICK SAND SIDE EDGE
    tileRects[21] = TILE(21, 0); // upper quick sand edge
